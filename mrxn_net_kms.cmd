...
echo kms服务器地址:kms.smilechen.cn,方便喜欢手动激活的朋友;
echo 有问题请反馈在我的博客留言，或者发送至我的邮箱:admin@mrxn.net;
echo 正在检查与激活服务器的连接情况......请耐心等待;
echo.
ping kms.smilechen.cn | find "超时"  > NUL &&  goto fail
ping kms.smilechen.cn | find "目标主机"  > NUL &&  goto fail
echo 成功连接上服务器……
...
if defined %EditionID% (
	...
	cscript //Nologo %windir%\system32\slmgr.vbs /skms kms.smilechen.cn
...
if DEFINED _Office%1Path (
    ...
    cscript //nologo ospp.vbs /sethst:kms.smilechen.cn >nul
