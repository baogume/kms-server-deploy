...
```shell
wget https://raw.githubusercontent.com/baogume/kms-server-deploy/master/kms-server-deploy.sh && bash kms-server-deploy.sh
```
...
### 下载(右键另存为即可) [mrxn_net_kms.cmd](https://github.com/baogume/kms-server-deploy/blob/master/mrxn_net_kms.cmd)
